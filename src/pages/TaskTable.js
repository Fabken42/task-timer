...
import { addTask, removeTask, moveTask, editTask, toggleConcluido, togglePendencia } from '../redux/taskSlice.js';
...
export default function TaskTable() {
  ...
  const handlePendencia = (position) => dispatch(togglePendencia(position));
